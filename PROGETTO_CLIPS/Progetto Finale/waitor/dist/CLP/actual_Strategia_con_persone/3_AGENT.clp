...
(defrule stop-gohome-status-pulisci (declare (salience 7))
	(go-home)
	(pulisci-table)
	?p <- (planned-action)
	=>
...
(defrule remove-gohome-status-pulisci (declare (salience 6))
	?g <- (go-home)
	(pulisci-table)
	=>
	(retract ?g)
...
(defrule stop-gohome-status-ordine (declare (salience 7))
	(go-home)
	(coda-ordini)
	?p <- (planned-action)
	=>
...
(defrule remove-gohome-status-ordine (declare (salience 6))
	?g <- (go-home)
	(coda-ordini)
	=>
	(retract ?g)
...
(defrule stop-execution-for-bump (declare (salience 5))
	?f1 <- (check-action ?i ?oper ?r ?c ?p3)
	?f2 <- (action-invalid)
	=>
...
(defrule k-percept-north	(declare (salience 20))
	...
	(test (> ?s ?old-s))
	?f <- (perc-vision 
		(step ?s) (time ?t) (pos-r ?r) (pos-c ?c) (direction north) 
		(perc1 ?x1) (perc2 ?x2) (perc3 ?x3)
		(perc4 ?x4) (perc5 ?x5) (perc6 ?x6)
		(perc7 ?x7) (perc8 ?x8) (perc9 ?x9)
	)
