...
;// l'agente ha inviato inform che l'ordine Ë accettato (e va bene)
...
;// l'agente ha inviato inform che l'ordine Ë accettato (e ma non sono vere le condizioni)
...
;// l'agente ha inviato inform che l'ordine Ë delayed (e va bene)
...
;// l'agente ha inviato inform che l'ordine Ë delayed (e non va bene dovrebbe essere accepted)
...
;// l'agente ha inviato inform che l'ordine Ë rejected (e non va bene dovrebbe essere accepted)
...
;// l'agente ha inviato inform che l'ordine Ë rejected (e non va bene dovrebbe essere delayed)
...
;// l'agente invia un'inform  per un servizio che non Ë pi˘ pending
...
;// operazione non serve, il tavolo Ë gia pulito
...
;// Operazione sbagliata perchË chiede finish prima che l'ordine sia stato completato
...
;// L'azione di CheckFinish  fallisce perchË l'agente non Ë accanto ad un tavolo 
...
;// L'azione di CheckFinish fallisce perchË la posizione indicata non 
;//contiene un tavolo 
