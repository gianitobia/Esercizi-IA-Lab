...
(deffacts rotations
	...
	(rotation (r_dir north) (m_dir west) (rotazione west) (dir_f west))
	(rotation (r_dir north) (m_dir east) (rotazione east) (dir_f east))
	(rotation (r_dir north) (m_dir south) (rotazione west) (dir_f west))
	;rotazione da uno stato del robot RIGHT;
	(rotation (r_dir east) (m_dir north) (rotazione west) (dir_f north))
	(rotation (r_dir east) (m_dir south) (rotazione east) (dir_f south))
	(rotation (r_dir east) (m_dir west) (rotazione west) (dir_f north))
	;rotazione da uno stato del robot DOWN;
	(rotation (r_dir south) (m_dir east) (rotazione west) (dir_f east))
	(rotation (r_dir south) (m_dir west) (rotazione east) (dir_f west))
	(rotation (r_dir south) (m_dir north) (rotazione east) (dir_f west))
	;rotazione da uno stato del robot LEFT;
	(rotation (r_dir west) (m_dir north) (rotazione east) (dir_f north))
	(rotation (r_dir west) (m_dir south) (rotazione west) (dir_f south))
	(rotation (r_dir west) (m_dir east) (rotazione east) (dir_f north))
)
