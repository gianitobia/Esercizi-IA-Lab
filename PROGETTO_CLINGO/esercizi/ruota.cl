...
-posizione(scorta,bagagliaio,S+1) :- rimuovi(scorta,bagagliaio,S), stato(S).
posizione(scorta,pavimento,S+1) :- rimuovi(scorta,bagagliaio,S), stato(S).
	
-posizione(bucata,asse,S+1) :- rimuovi(bucata,asse,S), stato(S).
posizione(bucata,pavimento,S+1) :- rimuovi(bucata,asse,S), stato(S).

-posizione(scorta,pavimento,S+1) :- monta(scorta,asse,S), stato(S).
posizione(scorta,asse,S+1) :- monta(scorta,asse,S), stato(S).
