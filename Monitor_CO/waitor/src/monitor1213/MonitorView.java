...
public class MonitorView extends ClipsView implements Observer {
    ...
    private final Map<String, ImageIcon> map_img;
    ...
    public MonitorView() {
        ...
        map_img = new HashMap<>();
        map_img.put("Wall", new ImageIcon("img" + File.separator + "wall.jpg"));
        map_img.put("Empty", new ImageIcon("img" + File.separator + "empty.png"));
        map_img.put("Seat", new ImageIcon("img" + File.separator + "seat.png"));
        map_img.put("Table_clean", new ImageIcon("img" + File.separator + "table_clean.png"));
        map_img.put("Table_dirty", new ImageIcon("img" + File.separator + "table_dirty.png"));
        map_img.put("TB", new ImageIcon("img" + File.separator + "trash_basket.png"));
        map_img.put("RB", new ImageIcon("img" + File.separator + "recycle_basket.png"));
        map_img.put("DD", new ImageIcon("img" + File.separator + "drink_dispenser.png"));
        map_img.put("FD", new ImageIcon("img" + File.separator + "food_dispenser.png"));

        map_img.put("Parking", new ImageIcon("img" + File.separator + "parking.png"));
        ...
        map_img.put("person_Person", new ImageIcon("img" + File.separator + "person_empty.png")); //Persona in piedi
        map_img.put("person_Seat", new ImageIcon("img" + File.separator + "person_seat.png")); //Persona seduta
